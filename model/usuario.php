  ...
  class Usuario extends Conexion
  {
    ...
    public function login($user, $clave)
    {
      ...
      */
      ...
      $consulta = 'SELECT id, nombre, apellidos, correo, cod_funcionario, cargo, region, comite, estado, t_factor, verificado FROM usuarios WHERE usuario="'.$user.'" and clave= MD5("'.$clave.'")';
      /*
      ...
      */
      ...
      if($verificar_usuario > 0){
        ...
        */
        ...
        $_SESSION['comite']  = $user['comite'];
        $_SESSION['estado']  = $user['estado'];
        $_SESSION['t_factor']  = $user['t_factor'];
        $_SESSION['cod_funcionario'] = $user['cod_funcionario'];
        ...
        */
        ...
        /*
          Recuerda:
          estado con valor: Activo 
          estado con valor: Inactivo
        */

        /*
          Recuerda:
          t_factor con valor: 0 : esta descativado 
          t_factor con valor: 1: esta activado
        */


        // Verificamos que la cuenta se encuentre activo, ademas de verificar el estado del inicio de sesión [two-factor]
