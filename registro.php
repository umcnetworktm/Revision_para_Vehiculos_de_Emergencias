...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?=BASE_URL?>public/css/bootstrap.min.<?=BASE_URL?>public/css">
    <!-- Font Awesome: para los iconos -->
    <link rel="stylesheet" href="<?=BASE_URL?>public/css/font-awesome.min.<?=BASE_URL?>public/css">
    <!-- Sweet Alert: alertas JavaScript presentables para el usuario (más bonitas que el alert) -->
    <link rel="stylesheet" href="<?=BASE_URL?>public/css/sweetalert.<?=BASE_URL?>public/css">
    <!-- Estilos personalizados: archivo personalizado 100% real no feik -->
    <link rel="stylesheet" href="<?=BASE_URL?>public/css/style.<?=BASE_URL?>public/css">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
          <!-- Margen superior (<?=BASE_URL?>public/css personalizado )-->
